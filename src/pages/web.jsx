    ...
    <Grid stackable columns={2}>
      ...
      <Grid.Column>
        ...
        <div className="description">
          ...
          <p>
            tried to establish a plan for the business social media accounts.
          </p>
          <br />
          <h3>Tech Stack</h3>
      ...
      <Grid.Column>
        ...
        <div className="description">
          <h3>Project Details</h3>
          <hr />
          <p>Stylish Gentleman is a fictional high end Mens apparel shop. </p>
          <h3>Challenges</h3>
          <hr />
          <p>
          ...
          <p>
            Create a brand and identity for the store that carried through to te
            site.
          </p>
          <p>create user stories and impliment UX/UI pricipals into design.</p>
          <br />
          <h3>Tech Stack</h3>
